...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const emailHtml = [
      ...
      '<span style="display:inline-block;background:#3b6cf5;color:#fff;font-weight:700;font-size:13px;padding:6px 12px;border-radius:8px">R0</span>',
      ...
      'Your R0Ready R01 access is ready. Bookmark the link below — it\'s your personal key to the app. No password needed.',
      '</p>',
    ...
    const emailRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: fromEmail,
        to: [email],
        subject: 'Your R0Ready R01 access link',
        html: emailHtml,
      }),
    });
